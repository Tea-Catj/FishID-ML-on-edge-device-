...
class Main:
    ...
    def __init__(self):
        ...
        #api change so we need to use getPredefinedDictionary instead dictionary_get
        self.aruco_dictionary = cv2.aruco.getPredefinedDictionary(cv2.aruco.DICT_5X5_1000)
